...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $data = [
            ...
            'respostasAdivinhacoesAtivas' => AdivinhacoesRespostas::select('adivinhacoes_respostas.id', 'adivinhacoes_respostas.created_at', 'adivinhacoes_respostas.resposta', 'adivinhacoes.resposta as resposta_correta', 'adivinhacoes.titulo', 'users.name',  'users.username')
            ...
            'comentarios' => Comment::select('comments.id', 'comments.created_at', 'comments.body', 'users.username', 'adivinhacoes.titulo')
