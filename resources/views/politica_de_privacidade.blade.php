...
<div class="text-white">
    ...
    <p><span >A sua privacidade é importante para nós. É política do Adivinhe e Ganhe respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://adivinheganhe.com.br/">Adivinhe e Ganhe</a>, e outros sites que possuímos e operamos.</span></p>
    ...
    <p><span >O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Adivinhe e Ganhe oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
    <ul>
        <li><span >A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</span></li>
        <li><span >B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, jogos de sorte ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</span></li>
        <li><span >C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Adivinhe e Ganhe, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
    </ul>
    ...
    <p><span >Esta política é efetiva a partir de&nbsp;9 September 2025 12:36</span></p>
</div>
@endsection