    ...
    <div class="card mb-4 shadow-sm">
        <div class="row g-0 flex-wrap">
            ...
            <div class="col-12 col-md-7 p-3 d-flex flex-column justify-content-between">
                <div>
                    <h5 class="text-primary fw-bold mb-2">{{ $adivinhacao->titulo.  ($adivinhacao->expired == true ? ' - EXPIRADA': '') }}</h5>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalLabel-{{ $adivinhacao->id }}">{{ $adivinhacao->titulo.  ($adivinhacao->expired == true ? ' - EXPIRADA': '')}}</h5>
