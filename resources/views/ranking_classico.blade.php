...
<div class="container mb-5 mt-2">
    <div class="text-center mb-5">
        <h2 class="fw-bold display-6">🏆 Ranking - Classico</h2>
        <p class="text-white">Os jogadores mais premiados do Adivinhe e Ganhe - Classico</p>
    </div>
            ...
            <div class="card shadow-sm border-0 h-100 text-center position-relative rounded-4">
                @if($index < 3)
                    ...
                    <div class="card-body d-flex flex-column justify-content-center">
                        ...
                        <h5 class="card-title mb-1 abrir-perfil" data-username="{{ $usuario->username }}">
                            <img src="{{ $usuario->image ?? 'https://ui-avatars.com/api/?name='.urlencode($usuario->username).'&background=random' }}"
