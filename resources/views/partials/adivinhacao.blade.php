    ...
    <div class="row g-0 flex-wrap">
        ...
        <div class="col-12 col-md-7 p-4 d-flex flex-column justify-content-between">
            <div>
                ...
                <button class="btn btn-outline-info btn-sm mb-3 rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#modalInformacoes" titulo="{ $adivinhacao->titulo. (!empty($adivinhacao->expired_at_br) && $adivinhacao->expired ? ' - EXPIRADA' : '') }}"
