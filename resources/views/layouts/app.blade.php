...
<head>
    ...
    <style>
        ...
        .btn-glow { transition: .3s ease; box-shadow: 0 0 10px #00f7ff; }
        .btn-glow:hover { transform: scale(1.05); box-shadow: 0 0 20px #00f7ff, 0 0 30px #00f7ff; }
        .nav-link { color: #fff !important; }
        .nav-link:hover { color: #00f7ff !important; }
...
<body class="bg-dark text-white d-flex flex-column min-vh-100">
    ...
    <script src="{{ asset('vendor/jquery/jquery.min.js') }}" defer crossorigin="anonymous"></script>
    <script src="{{ asset('vendor/bootstrap/bootstrap.bundle.min.js') }}" defer crossorigin="anonymous"></script>
    <script src="{{ asset('vendor/sweetalert2/sweetalert.min.js') }}" defer></script>
    ...
    @isset($enable_adsense)
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client={{ env('GOOGLE_ADSENSE_TAG', 'ca-pub-2128338486173774') }}" crossorigin="anonymous"></script>
    @endisset
